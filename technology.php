...
<html lang="en">
    <head>
        ...
        <link rel="preload" as="image" href="assets/img/technology/bg-masthead-technology.png">
        ...
        <style>
            ...
            header.masthead {
                background: url(assets/img/technology/bg-masthead-technology.png);
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item my-auto"><a class="nav-link" href="#digital-life">Culture</a></li>
